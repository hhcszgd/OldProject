...
@property(nonatomic,weak)OldMsgLabel * otherContentLabel ;
...
//        [self addGestureRecognizer:press];
        ...
        OldMsgLabel * otherContentLabel = [[OldMsgLabel alloc]init];
        otherContentLabel.isCopyable = YES ;
        otherContentLabel.numberOfLines=0;
        otherContentLabel.font = [UIFont systemFontOfSize:15];
        otherContentLabel.textColor = [UIColor colorWithRed:51/256.0 green:51/256.0 blue:51/256.0 alpha:1];
...
//        /Users/wy/Documents/sallerVersion/lkjl/zjlao-swift/zjlao/Classes/Globle/IM/Sub/ChatVC/View/OtherChatCell.m:123:48: Definition of 'XMPPMessageArchiving_Message_CoreDataObject' must be imported from module 'XMPPFramework.XMPPMessageArchiving_Message_CoreDataObject' before it is required
...
-(void)longPress
{
    ...
    item.accessibilityFrame = CGRectMake(0, 0, 44, 44);
    [UIMenuController sharedMenuController].menuItems = @[item];
    [[UIMenuController sharedMenuController] setMenuVisible:YES animated:YES];
    NSLog(@"_%d_%@",__LINE__,NSStringFromCGRect([UIMenuController sharedMenuController].menuFrame));
     NSLog(@"_%d_%@",__LINE__,[UIMenuController sharedMenuController]);
     NSLog(@"_%d_%@",__LINE__,NSStringFromCGRect(self.frame));
}
-(void)newFunc{
    UIPasteboard *pboard = [UIPasteboard generalPasteboard];
    pboard.string = self.otherContentLabel.text;
}
-(void)layoutSubviews{
