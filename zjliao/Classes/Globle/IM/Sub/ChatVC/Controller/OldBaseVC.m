...
//    NSLog(@"_%@_%d_这是基类中 取到的网络状态  %ld",[self class] , __LINE__,NetWorkingStatus)
//    NSLog(@"_%@_%d_这是基类中 取到的网络状态  %ld",[self class] , __LINE__,self.netStatus)
...
//    [self.view addSubview:viewWhenDisconnect];
    ...
    viewWhenDisconnect.backgroundColor =   [UIColor colorWithRed:244/256.0 green:244/256.0 blue:244/256.0 alpha:1];
...
-(void)reconnectClick:(UIButton*)sender{
    NSLog(@"_%@_%d_%@",[self class] , __LINE__,@"在跟控制器中  , 点击重连的回调方法");
...
-(void)dealloc{
    ...
    NSLog(@"_%@_%d_%@",[self class] , __LINE__,@"销毁");
