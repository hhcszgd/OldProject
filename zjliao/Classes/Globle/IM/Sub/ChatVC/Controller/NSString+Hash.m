...
-(NSAttributedString*)dealStrWithLabelFont:(UIFont*)font;{
    ...
    if (matches.count>0) {
        for (int i = 0 ; i< matches.count; i++) {
            ...
            NSString * gifname =  [[NSBundle bundleWithPath:[[NSBundle mainBundle] pathForResource:@"Resource" ofType:@"bundle"]] pathForResource:imgName ofType:@"gif" inDirectory: @"face_img"];
            UIImage* gif = [UIImage sd_animatedGIFNamed:gifname];
