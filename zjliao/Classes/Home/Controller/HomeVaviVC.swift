...
class HomeVaviVC: UINavigationController {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        self.tabBarItem.image = UIImage(named: "orderListNormal")
        self.tabBarItem.selectedImage = UIImage(named: "orderListSelect")
...
//        self.tabBarItem.title = NSLocalizedString("tabBar_home", tableName: LanguageTableName, bundle: Bundle.main, value:"", comment: "") // 加载指定语言包名(LocalizableEN) 里的键对应的值
        self.tabBarItem.title  = GDLanguageManager.titleByKey(key: "tabBar_seller") //gotTitleStr(key: "tabBar_home")
