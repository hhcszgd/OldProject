...
class GDNavigatBar: GDView {
    ...
    convenience init(type:NaviBarStyle){
        ...
        switch currentType {
        case .withBackBtn:
            leftSubViewsContainer.backgroundColor = UIColor.randomClr()
            rightSubViewsContainer.backgroundColor = UIColor.randomClr()
            
            self.addSubview(backBtn)
            self.addSubview(leftSubViewsContainer)
            self.addSubview(rightSubViewsContainer)
            backBtn.backgroundColor = UIColor.randomClr()
