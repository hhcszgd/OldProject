...
@interface TotalOrderRefreshAutoFooter()
@property (weak, nonatomic) UILabel *label;
@property (strong, nonatomic) UISwitch *s;
@property(nonatomic,weak)UIImageView * logo ;
@property (weak, nonatomic) UIActivityIndicatorView *loading;
@end


@implementation TotalOrderRefreshAutoFooter
#pragma mark - 重写方法
...
- (void)prepare
{
    ...
    [logo sd_setImageWithURL:u placeholderImage:[UIImage imageNamed:@"accountBiiMap"]options:SDWebImageCacheMemoryOnly];
...
-(void)setupFrame
{
    ...
    CGSize  labelSize =  [self.label.text sizeWithFont:self.label.font MaxSize:CGSizeMake(screenW, 50)];
    CGFloat margin = 5;
    CGFloat logoW = 44 ;
    CGFloat logoH = 19;
    self.logo.frame=CGRectMake((self.bounds.size.width-logoW)/2, margin, logoW, logoH);
    LOG(@"_%@_%d_%@",[self class] , __LINE__,NSStringFromCGRect(self.frame))
