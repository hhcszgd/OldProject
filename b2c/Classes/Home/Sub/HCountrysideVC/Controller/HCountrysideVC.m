...
//
//@property(nonatomic,strong)HFocusCell * timeCell ;
//@property (nonatomic, strong) ShopCar *shopCarBtn;
@end

@implementation HCountrysideVC
...
-(void)configmentNavigation{
    ...
    ;
    self.navigationBarRightActionViews = @[self.shopCarBtn,messageButton];
}

////即将跳到cell的通知的执行
//-(void)cellComposeClick:(NSNotification*)notifi
//{
//    HCellComposeModel * model =  ( HCellComposeModel * )notifi.userInfo[@"CountrysideCellComposeViewModel"];
...
////        self.timeCell =nil;
////        self.timeCell = (HFocusCell * )cell;
////    }
//
//    if (indexPath.section==0 && indexPath.row==0 && [cell isKindOfClass:[HFocusCell class]]) {
//        if (self.timeCell!=cell) {//
//            [self.timeCell removeTimer];
//            self.timeCell =nil;
//            LOG(@"_%@_%d_打印轮播cell到底会产生几个 ------------------\n\n%@\n\n\n",[self class] , __LINE__,cell);
//            self.timeCell = (HFocusCell *)cell;//记录轮播图, 好移除定时器
//        }
//    }
//    
//    
...
//    
//    
//    [[UserInfo shareUserInfo] gotCountrysideDataSuccess:^(ResponseObject *responseObject) {
...
//                    if ([composeModel.actionKey isEqualToString:@"HCouponsVC"]) {
//                        composeModel.actionKey = @"CouponsDetailVC";
//                    }
...
//                 LOG(@"_%@_%d_%@",[self class] , __LINE__,composeModel.actionKey)
//                if ([composeModel.actionKey isEqualToString:@"HCouponsVC"]) {
//                    composeModel.ID = composeModel.coupons_id;
//                    composeModel.actionKey = @"CouponsDetailVC";
//                }
...
//    
//    
//    [[UserInfo shareUserInfo] gotGuessLikeDataWithChannel_id:@"105" PageNum:++self.guessLikePageNum success:^(ResponseObject *responseObject) {
//        LOG(@"_%@_%d_%@",[self class] , __LINE__,responseObject.data)
