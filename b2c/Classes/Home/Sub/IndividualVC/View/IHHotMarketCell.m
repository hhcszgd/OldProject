...
@implementation IHHotMarketCell
...
-(void)composeClick:(HCellBaseComposeView*)sender
{
    if (sender.composeModel) {
        ...
        [[NSNotificationCenter defaultCenter] postNotificationName:@"IndividualCellComposeViewClick" object:nil userInfo:pragma];
    }
}
@end
