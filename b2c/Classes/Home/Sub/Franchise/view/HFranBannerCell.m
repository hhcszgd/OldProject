...
@interface HFranBannerCell()<UICollectionViewDelegate,UICollectionViewDataSource,UICollectionViewDelegateFlowLayout>
...
@end
@implementation HFranBannerCell
...
- (UIPageControl *)page{
    if (_page == nil) {
        ...
        _page.currentPageIndicatorTintColor = [UIColor colorWithHexString:@"ffad01"];
        _page.pageIndicatorTintColor = [[UIColor whiteColor] colorWithAlphaComponent:0.7];
//        [_page setValue:[UIImage imageNamed:@"icon_carousel_nor_franchise"]forKey:@"pageImage"];
//        [_page setValue:[UIImage imageNamed:@"icon_carousel_sel_franchise"] forKey:@"currentPageImage"];
...
- (void)collectionView:(UICollectionView *)collectionView didSelectItemAtIndexPath:(NSIndexPath *)indexPath{
    if ([self.delegate respondsToSelector:@selector(HFranBannerCellActionToActiveWithSubModel:)]) {
        [self.delegate performSelector:@selector(HFranBannerCellActionToActiveWithSubModel:) withObject:self.dataArray[indexPath.item]];
    }
}
