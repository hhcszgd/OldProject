...
@end
@implementation HFOverflowSubCell
...
- (UILabel *)count{
    if (_count == nil) {
        ...
        [_count configmentfont:[UIFont systemFontOfSize:10] textColor:[UIColor whiteColor] backColor:[UIColor clearColor] textAligement:0 cornerRadius:0 text:@""];
        [_count sizeToFit];
    }
    return _count;
}
