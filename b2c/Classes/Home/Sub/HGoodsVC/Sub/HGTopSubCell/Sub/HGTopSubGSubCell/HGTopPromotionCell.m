...
- (UILabel *)promotionStyle1{
    if (_promotionStyle1 == nil) {
        ...
        [_promotionStyle1 configmentfont:[UIFont systemFontOfSize:11 * zkqScale] textColor:[UIColor colorWithHexString:@"c456b0"] backColor:[UIColor whiteColor] textAligement:1 cornerRadius:(14 * zkqScale)/2.0 text:@""];
        _promotionStyle1.layer.borderWidth = 1;
        _promotionStyle1.layer.borderColor = [UIColor colorWithHexString:@"c456b0"].CGColor;
...
//        self.lineView = lineView;
        ...
        [lineView mas_makeConstraints:^(MASConstraintMaker *make) {
            make.top.equalTo(self.contentView.mas_top).offset(46);
...
//        [lineView mas_makeConstraints:^(MASConstraintMaker *make) {
//          self.contraintTop =   make.top.equalTo(self.promotion.mas_bottom).offset(14);
...
//        subView.backgroundColor = BackgroundGray;
//        [subView mas_makeConstraints:^(MASConstraintMaker *make) {
//            make.bottom.right.equalTo(self.contentView);
//            make.left.equalTo(self.promotionStyle1.mas_left);
//            make.height.equalTo(@(1));
//        }];
...
//        [self.contraintWidth uninstall];
        ...
        if ([promotModel.sea isEqualToString:@"yes"]) {
            self.promotionStyle1.layer.borderWidth = 1;
            self.promotionStyle1.layer.borderColor = [UIColor colorWithHexString:@"c456b0"].CGColor;
            [self.promotionStyle1 configmentfont:[UIFont systemFontOfSize:11 * zkqScale] textColor:[UIColor colorWithHexString:@"c456b0"] backColor:[UIColor whiteColor] textAligement:1 cornerRadius:(14 * zkqScale)/2.0 text:@"满减"];
        }else {
            self.promotionStyle1.layer.borderWidth = 0.0;
            self.promotionStyle1.layer.borderColor = [UIColor clearColor].CGColor;
           [self.promotionStyle1 configmentfont:[UIFont systemFontOfSize:11 * zkqScale] textColor:[UIColor colorWithHexString:@"ffffff "] backColor:THEMECOLOR textAligement:1 cornerRadius:(14 * zkqScale)/2.0 text:@"满减"];
        }
