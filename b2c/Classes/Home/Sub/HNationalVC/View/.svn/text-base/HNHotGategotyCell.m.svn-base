...
//  b2c
//
//  Created by 张凯强 on 16/8/8.
//  Copyright © 2016年 www.16lao.com. All rights reserved.
//

#import "HNHotGategotyCell.h"

@interface HNHotGategotyCell()
...
@end
@implementation HNHotGategotyCell
...
- (UILabel *)classifyTitle{
    if (_classifyTitle == nil) {
        ...
        [_classifyTitle configmentfont:[UIFont systemFontOfSize:14 * SCALE] textColor:[UIColor colorWithHexString:@"ffffff"] backColor:[UIColor clearColor] textAligement:1 cornerRadius:0 text:@""];
...
- (void)setCellStyle:(HEaCellStyle)cellStyle{
    ...
    switch (cellStyle) {
        case cellStyleIsBig:
        {
            ...
            self.classifyTitle.backgroundColor = [UIColor clearColor];
        }
            break;
        case cellStyleIsSmall:
        {
            ...
            [self.classifyTitle mas_makeConstraints:^(MASConstraintMaker *make) {
                ...
                self.constraint2 = make.centerY.equalTo(self.contentView);
            }];
            self.classifyTitle.backgroundColor = [[UIColor blackColor] colorWithAlphaComponent:0.5];
        }
            break;
        default:
            break;
