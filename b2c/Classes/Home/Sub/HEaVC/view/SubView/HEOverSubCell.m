...
- (UILabel *)title{
    if (_title == nil) {
        ...
        [_title configmentfont:[UIFont systemFontOfSize:11 ] textColor:[UIColor colorWithHexString:@"333333"] backColor:[UIColor whiteColor] textAligement:1 cornerRadius:0 text:@""];
...
- (UILabel *)price{
    if (_price == nil) {
        ...
        [_price configmentfont:[UIFont systemFontOfSize:11 ] textColor:[UIColor colorWithHexString:@"3167f0"] backColor:[UIColor whiteColor] textAligement:0 cornerRadius:0 text:@""];
        [_price sizeToFit];
    }
    return _price;
}
