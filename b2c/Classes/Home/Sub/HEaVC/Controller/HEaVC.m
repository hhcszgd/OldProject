...
@interface HEaVC ()
//<UICollectionViewDataSource,UICollectionViewDelegate,UICollectionViewDelegateFlowLayout,HAPBannerCellDelegate,HEOverflowSellCellDelegate>
...
//- (void)upRefresh{
//    
//    [[UserInfo shareUserInfo] gotGuessLikeDataWithChannel_id:@"104" PageNum:self.pageNumber success:^(ResponseObject *responseObject) {
...
//        return YES;
//    }else if ([key isEqualToString:@"hotkind"]) {
//        return YES;
...
//    }
//    if ([key isEqualToString:@"hotkind"]) {
//        [self.cellArray addObject:@"HAPHotCategotyCell"];
//    }
...
//    [self.col registerClass:[HAPHotCategotyCell class] forCellWithReuseIdentifier:@"HAPHotCategotyCell"];
...
//    if ([self.cellArray[section] isEqualToString:@"HAPHotCategotyCell"]){
//       
//        
...
//    }else if ([self.cellArray[indexPath.section] isEqualToString:@"HAPHotCategotyCell"]){
//        HEaBaseModel *baseModel = self.dataArray[indexPath.section];
//        
//        cell.customModel = baseModel.items[indexPath.item];
//        if (indexPath.item < 4) {
...
//        }
//        CustomCollectionModel *model = baseModel.items[indexPath.item];
//        LOG(@"%@,%d,%@-----%@",[self class], __LINE__,NSStringFromCGRect(cell.frame),model.classify_name)
...
//    }
//    if ([self.cellArray[indexPath.section] isEqualToString:@"HAPHotCategotyCell"]) {
//        if (indexPath.item < 4) {
...
//    header.leftView.backgroundColor = [UIColor colorWithHexString:@"2fb4ef"];
//    header.channelLabel.textColor = [UIColor colorWithHexString:@"2fb4ef"];
