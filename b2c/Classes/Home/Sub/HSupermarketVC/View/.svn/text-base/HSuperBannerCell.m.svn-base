...
@interface HSuperBannerCell()<UICollectionViewDelegate,UICollectionViewDataSource,UICollectionViewDelegateFlowLayout>
...
@end
@implementation HSuperBannerCell
...
- (UIPageControl *)page{
    if (_page == nil) {
        ...
        _page.currentPageIndicatorTintColor = [UIColor colorWithHexString:@"ff7900"];
...
- (void)collectionView:(UICollectionView *)collectionView didSelectItemAtIndexPath:(NSIndexPath *)indexPath{
    if ([self.delegate respondsToSelector:@selector(HSuperBannerCellActionToSuperMarketActiveWithSubModel:)]) {
        [self.delegate performSelector:@selector(HSuperBannerCellActionToSuperMarketActiveWithSubModel:) withObject:self.dataArray[indexPath.item]];
    }
}
