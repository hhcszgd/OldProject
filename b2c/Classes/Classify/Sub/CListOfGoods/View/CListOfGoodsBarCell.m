...
- (void)setClistModel:(ClistOfGoodsModel *)clistModel{
    ...
    [self.goodPrice setAttributedText:[clistModel.price dealhomePricefirstFont:[UIFont systemFontOfSize:12 * SCALE] lastfont:[UIFont systemFontOfSize:12 * SCALE]]];
...
- (void)setSubModel:(HStoreSubModel *)subModel{
    ...
    [self.goodPrice setAttributedText:[subModel.price dealhomePricefirstFont:[UIFont systemFontOfSize:12 * SCALE] lastfont:[UIFont systemFontOfSize:12 * SCALE]]];    [self.storeName setText:subModel.shop_short_name];
