...
/**商品详情页中的各种点击操作需要传值到其他页面的通知名字*/
static NSString *GOODSSNETVALUE = @"GOODSSNETVALUE";
static NSString * MAINDOMAIN = @"https://www.zjlao.com";
static NSString * WAPDOMAIN =  @"https://m.zjlao.com";
static NSString * APIDOMAIN  = @"https://api.zjlao.com";
static NSString * IMGDOMAIN  = @"https://i0.zjlao.com";
