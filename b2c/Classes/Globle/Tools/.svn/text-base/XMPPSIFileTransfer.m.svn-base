...
#pragma mark This file must be compiled with ARC. Use -fobjc-arc flag (or convert project to ARC).
#endif
...
#pragma mark change to actual image
    ...
    [file addAttributeWithName:@"size" stringValue:[[NSString alloc] initWithFormat:@"%ld", [data length]]];
    [si addChild:file];
...
{
//    LOG(@"_%@_%d_%@",[self class] , __LINE__,inIq.to);
//    LOG(@"_%@_%d_%@",[self class] , __LINE__,inIq.from);
